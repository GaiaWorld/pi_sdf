...
|---|---|---|---|---|---|---|
| 0 | _shared.md base.md geom.md | 9 | — | ✔ | ✔ | 待用户提交 |
| 1 | outline.md sdf.md grid.md | 8 | 0 | ✔ | ✔ | 待用户提交 |
| 2 | bake.md raster.md | 6 | 0、1 | ✔ | ✔ | 待用户提交 |
| 3 | font.md path.md | 6 | 0、1 | ✔ | ✔ | 待用户提交 |
| 4 | native.md wasm.md | 3 | 3 | ✔ | ✔ | 待用户提交 |
